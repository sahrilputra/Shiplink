...
export const SavedBoxCard = ({ variant, data }) => {
    return (
        <>
            {variant === 'list' ? (
                <>
                    <div className="hover:bg-slate-200/30 container w-[100%] flex flex-row justify-between px-4 gap-2  py-[5px] bg-white rounded-sm shadow-md border border-zinc-600 border-opacity-50 items-center">
                ...
                <>
                    <div className="hover:bg-slate-200/30 w-[275px] px-[5px] py-5 bg-white rounded-lg shadow-md border border-zinc-600 border-opacity-50 flex-col justify-start items-start gap-2 inline-flex">
