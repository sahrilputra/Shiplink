...
export const DeleteCountryDialog = ({ open, setOpen, deleteID, reloadData }) => {
        ...
        try {
            for (const deleteID of deleteIDs) {
                const response = await axios.post(
                    `/api/admin/config/countries/delete`,
                    { data: deleteID }
                );
                toast({
                    ...
                    <AlertDialog open={open} setOpen={setOpen}>
                        <AlertDialogContent>
                            <AlertDialogHeader>
                                ...
                                <AlertDialogDescription>
                                    This action cannot be undone. This Country will be deleted permanently.
                                </AlertDialogDescription>
                            </AlertDialogHeader>
                            <AlertDialogFooter>
                                <Button
