...
export const DeleteCategory = ({ open, setOpen, deleteID, reloadData }) => {
                    ...
                    <AlertDialog open={open} setOpen={setOpen}>
                        <AlertDialogContent>
                            <AlertDialogHeader>
                                ...
                                <AlertDialogDescription>
                                    This action cannot be undone. You have selected {deleteID.length} Category{deleteID.length > 1 ? 's' : ''} and it will be deleted permanently.
                                </AlertDialogDescription>
                            </AlertDialogHeader>
                            <AlertDialogFooter>
                                <Button
