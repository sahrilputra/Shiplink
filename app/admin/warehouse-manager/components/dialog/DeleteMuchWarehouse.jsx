...
export const DeleteMuchWarehouse = ({ open, setOpen, deleteID, reloadData }) => {
    ...
    const fetchData = async (deleteIDs) => {
        ...
        try {
            ...
            setLoading(false);
            toast({
                title: 'Error Deleting Warehouses!',
                    ...
                    <AlertDialog open={open} setOpen={setOpen}>
                        <AlertDialogContent>
                            <AlertDialogHeader>
                                ...
                                <AlertDialogDescription>
                                    This action cannot be undone. You have selected {deleteID.length} Warehouse{deleteID.length > 1 ? 's' : ''} and it will be deleted permanently.
                                </AlertDialogDescription>
                            </AlertDialogHeader>
                            <AlertDialogFooter>
                                <Button
