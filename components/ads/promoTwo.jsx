...
export const PromoTwo = () => {
    return (
        <div className="w-[378px] h-[665px] relative">
            <div className="w-[378px] h-[665px] left-0 top-0 absolute bg-white rounded-md" />
            ...
            <div className="w-[275px] h-[99px] left-[58px] top-[74px] absolute text-center text-black text-xl font-semibold font-['Poppins']">If you have any questions or need any help, please contact us</div>
            <div className="left-[80px] top-[223px] absolute flex-col justify-center items-start gap-[21px] inline-flex">
                ...
                <div className="w-[212px] justify-start items-center gap-2.5 inline-flex">
                    <div className="w-9 h-9 py-[1.50px] justify-center items-center flex" />
            ...
            <div className="w-[292px] h-12 px-10 left-[41px] top-[479px] absolute bg-red-700 rounded shadow justify-center items-center gap-2 inline-flex">
