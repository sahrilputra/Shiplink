    ...
    return (
        <>
            <NextLink
                ...
                {isActive ? (
                    <>
                        <div className={`${styles.content} mb-[-8px] px-[15px] py-2 bg-red-700 rounded-md justify-start items-center gap-3 flex w-[220px]`}>
                    ...
                    <>
                        <div className="flex flex-col w-max mt-2">
                            {
                                isFirst === 'true' ? (
