...
const buttonVariants = cva(
  "inline-flex items-center justify-center whitespace-nowrap rounded-md text-sm font-medium ring-offset-white transition-colors focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-slate-950  disabled:pointer-events-none disabled:opacity-50 dark:ring-offset-slate-950 dark:focus-visible:ring-slate-300",
  {
    variants: {
      variant: {
        ...
        outline:
          "border shadow border-slate-300 bg-white hover:bg-slate-100 hover:text-slate-900 dark:border-slate-800 dark:bg-slate-950 dark:hover:bg-slate-800 dark:hover:text-slate-50",
        secondary:
        ...
        filter: "bg-white text-slate-900 border border-slate-300 hover:bg-slate-100 hover:text-slate-900 dark:bg-slate-950 dark:border-slate-800 dark:hover:bg-slate-800 dark:hover:text-slate-50",
        filterActive: "bg-red-700 shadow text-slate-50 hover:bg-red-800/90 dark:bg-red-900 dark:text-slate-50 dark:hover:bg-red-900/90",
      },
      size: {
        default: "h-10 px-4 py-2 rounded",
        sm: "h-9 rounded-sm px-3",
        xs: "h-[30px] rounded py-3 text-xs px-3",
        lg: "h-11 rounded-md px-8",
        icon: "h-10 w-10 rounded-md",
        filter: "w-8 h-8 rounded p-0",
        tableIcon: "h-8 w-8 rounded-[3px]",
      },
    },
    defaultVariants: {
      variant: "default",
